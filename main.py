...
def contents(id_):
    try:
        ...
        return render_template('bed-contents.html',bedNum=bed.bed, name=bed.owner, plant=bed.plant_species, date_planted=bed.date_planted, date_finished=bed.date_finished, last_watered=bed.last_watered)
